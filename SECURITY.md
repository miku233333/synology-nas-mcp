...
- The HTTP service requires a private Bearer token. The supplied Compose file publishes no host ports. It is intended for trusted Docker networking and the optional authenticated OpenAI tunnel, not direct public exposure.
